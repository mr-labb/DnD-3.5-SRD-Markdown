...
title: Bestiary/MM1/Pyrohydra, Five-Headed
tags: 
 - 35E_SRD
 - Monster
Monster: Pyrohydra, Five-Headed
Size: Huge
Type: Magical Beast
Subtype: 
CR: 6
...
forceColumns: true
source: MM1 
name: Pyrohydra, Five-Headed
image: [[Hydra, Five-Headed.PNG]]
race: Hydra, Five-Headed
class: 
level: 
size: Huge
type: Magical Beast
...
special_qualities:
 - name:
   desc: [[Compendium/Basics/Abilities and Conditions/Darkvision|Darkvision]] 60 ft., fast healing 15, [[low-light vision]], [[Scent]]
actions:
  - name: Full Attack
    desc: "5 bites +6 melee (1d10+3)"
  - name: Attack
    desc: "5 bites +6 melee (1d10+3)"
...
traits:
   - name: Feats
     desc: Combat Reflexes (B), Iron Will, Toughness
combat_gear:  
```
