...
aliases:
 - Wererat - Hybrid Form
title: Bestiary/MM1/Lycanthrope, Wererat, Hybrid Form
tags: 
 - 35E_SRD
 - Monster
Monster: Lycanthrope, Wererat, Hybrid Form
Size: Medium
Type: Humanoid
...
forceColumns: true
source: MM1 
name: Lycanthrope, Wererat, Hybrid Form
image: [[Lycanthrope, Wererat, Hybrid Form.PNG]]
race: Lycanthrope, Wererat, Hybrid Form
class: 
level: 
size: Medium
type: Humanoid
...
special_qualities:
 - name:
   desc: Alternate form, rat empathy, [[Damage Reduction]] 10/silver, [[low-light vision]], [[Scent]]
actions:
  - name: Full Attack
    desc: "Rapier +4 melee (1d6+1/18-20) and bite -1 melee (1d6 plus disease); or light crossbow +4 ranged (1d8/19-20)"
  - name: Attack
    desc: "Rapier +5 melee (1d6+1/18-20) or light crossbow +4 ranged (1d8/19-20)"
  - name: special attacks
    desc: "Curse of lycanthropy, disease"
spells:
  - ""
traits:
   - name: Feats
     desc: Alertness, Dodge, Iron Will (B), WeaponFinesse (B)
combat_gear:  
```
