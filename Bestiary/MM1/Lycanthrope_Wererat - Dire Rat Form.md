...
forceColumns: true
source: MM1 
name: Lycanthrope, Wererat, Dire Rat Form
image: [[Lycanthrope, Wererat, Dire Rat Form.PNG]]
race: Lycanthrope, Wererat, Dire Rat Form
class: 
level: 
size: Small
type: Humanoid
...
actions:
  - name: Full Attack
    desc: "Bite +6 melee (1d4+1 plus disease)"
  - name: Attack
    desc: "Bite +6 melee (1d4+1 plus disease)"
