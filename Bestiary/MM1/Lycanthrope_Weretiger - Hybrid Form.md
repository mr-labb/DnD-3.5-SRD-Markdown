...
title: Bestiary/MM1/Lycanthrope, Weretiger, Hybrid Form
tags: 
 - 35E_SRD
 - Monster
Monster: Lycanthrope, Weretiger, Hybrid Form
Size: Large
Type: Humanoid
...
forceColumns: true
source: MM1 
name: Lycanthrope, Weretiger, Hybrid Form
image: [[Lycanthrope, Weretiger, Hybrid Form.PNG]]
race: Lycanthrope, Weretiger, Hybrid Form
class: 
level: 
size: Large
type: Humanoid
...
special_qualities:
 - name:
   desc: Alternate form, tiger empathy, damage reduction 10/silver, low-light vision, scent
actions:
  - name: Full Attack
    desc: "2 claws +11 melee (1d8+7) and bite +6 melee (2d6+3)"
  - name: Attack
    desc: "Claw +11 melee (1d8+7)"
...
traits:
   - name: Feats
     desc: Alertness (B), Combat Reflexes, Improved Initiative,Improved Natural Attack (bite, claw), Iron Will (B)
combat_gear:  
```
