...
forceColumns: true
source: MM1 
name: Lycanthrope, Werewolf Lord, Dire Wolf Form
image: [[Lycanthrope, Werewolf Lord, Dire Wolf Form.PNG]]
race: Lycanthrope, Werewolf Lord, Dire Wolf Form
class: 
level: 
size: Large
type: Humanoid
...
actions:
  - name: Full Attack
    desc: "Bite +25 melee (2d6+16/19-20)"
  - name: Attack
    desc: "Bite +25 melee (2d6+16/19-20)"
  - name: special attacks
    desc: "Curse of lycanthropy, trip"
spells:
  - ""
traits:
   - name: Feats
