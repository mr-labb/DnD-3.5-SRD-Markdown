...
forceColumns: true
source: MM1 
name: Lycanthrope, Wereboar, Hybrid Form
image: [[Lycanthrope, Wereboar, Hybrid Form.PNG]]
race: Lycanthrope, Wereboar, Hybrid Form
class: 
level: 
size: Medium
type: Humanoid
...
actions:
  - name: Full Attack
    desc: "Battleaxe +6 melee (1d8+4/x3) and gore +1 melee (1d6+1); or 2 claws +6 melee (1d4+3) and gore +1 melee (1d6+1)"
  - name: Attack
    desc: "Battleaxe +6 melee (1d8+4/x3) or claw +6 melee (1d4+3)"
...
traits:
   - name: Feats
     desc: Alertness (B), Improved Bull Rush, Iron Will (B),Power Attack, Toughness
combat_gear:  
```
