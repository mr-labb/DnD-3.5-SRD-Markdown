...
image: [[Water Elemental, Greater.PNG]]
...
touch: 13
flatfooted: 17
AC_desc: -2 size, +5 Dex, +9 natural
hp: 199
hit_dice: 21d8+105
initiative: 5
...
actions:
  - name: Full Attack
    desc: "2 slams +21 melee (2d10+8)"
  - name: Attack
    desc: "Slam +21 melee (2d10+8)"
...
traits:
   - name: Feats
     desc: Alertness, Cleave, Great Cleave, Improved Bull Rush, Improved Sunder, Iron Will, Lightning Reflexes, Power Attack
combat_gear:  
```
...
The elemental is 36 ft tall and weights 21000 lb.
