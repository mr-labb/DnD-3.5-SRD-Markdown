...
image: [[Lycanthrope, Weretiger, Human Form.PNG]]
...
touch: 10
flatfooted: 17
AC_desc: +2 natural, +5 breastplate
hp: 50
...
actions:
  - name: Full Attack
    desc: "Glaive +6 melee (1d10+1/x3) or composite longbow (+1 Str bonus) +5 ranged (1d8+1/x3)"
  - name: Attack
    desc: "Glaive +6 melee (1d10+1/x3) or composite longbow (+1 Str bonus) +5 ranged (1d8+1/x3)"
