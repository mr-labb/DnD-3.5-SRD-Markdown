...
title: Bestiary/MM1/Lycanthrope, Werewolf Lord, Hybrid Form
tags: 
 - 35E_SRD
 - Monster
Monster: Lycanthrope, Werewolf Lord, Hybrid Form
Size: Large
Type: Humanoid
...
forceColumns: true
source: MM1 
name: Lycanthrope, Werewolf Lord, Hybrid Form
image: [[Lycanthrope, Werewolf Lord, Hybrid Form.PNG]]
race: Lycanthrope, Werewolf Lord, Hybrid Form
class: 
level: 
size: Large
type: Humanoid
...
touch: 13
flatfooted: 15
AC_desc: -1 size, +4 Dex, +6 natural
hp: 132
hit_dice: 10d10+20 plus 6d8+30
initiative: 4
...
actions:
  - name: Full Attack
    desc: "2 claws +24 melee (1d6+11) and bite +20 melee (2d6+5/19-20); or +2 bastard sword +27/+22/+17 melee (2d8+15/17-20) and bite +20 melee (2d6+5/19-20)"
  - name: Attack
    desc: "Claw +24 melee (1d6+11) or +2 bastard sword +27 melee (2d8+15/17-20)"
...
traits:
   - name: Feats
     desc: Alertness, Cleave, Combat Reflexes, Exotic Weapon Proficiency (bastard sword),Improved Critical (bastard sword), Improved Critical (bite), Improved Natural Armor, Improved Natural Attack (bite),Iron Will (B), Power Attack, Run, Stealthy, Track (B),Weapon Focus (bastard sword), Weapon Focus (bite), Weapon Specialization (bastard sword)
combat_gear:  
```
